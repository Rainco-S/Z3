...
We use test cases to validate the correctness of our method, which can be found at \cite{Z3}, where we provide various basic, timer, and probabilistic connectors along with their mutants to be tested, and the corresponding graphs are also illustrated. Here we choose three representative examples to show how the system works.
