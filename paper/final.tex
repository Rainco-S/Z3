...
\begin{itemize}
    \item modeling basic, timed, and probabilistic Reo connectors in Z3, and automated refinement/equivalence checking using Z3, including counterexample generation;
    \item a fault-based test case generation approach for detecting common connector design errors;
